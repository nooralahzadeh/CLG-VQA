...
class AttModel(CaptionModel):
    def __init__(self, args, config,tgt_vocab_size, bos_token_id, eos_token_id, pad_token_id):
        super(AttModel, self).__init__()
        self.args = args
        self.vocab_size = tgt_vocab_size
        self.input_encoding_size = config.hidden_size
        self.dropout = config.hidden_dropout_prob
        self.max_seq_length = 8
        self.att_feat_size = config.hidden_size
        self.att_hid_size = config.hidden_size

        self.bos_idx = bos_token_id
        self.eos_idx = eos_token_id
        self.pad_idx = pad_token_id

        self.use_bn = 0 # whether to use batch normalization or not

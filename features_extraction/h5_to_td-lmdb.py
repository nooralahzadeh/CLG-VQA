...
if __name__ == '__main__':
    ...
    parser.add_argument('--h5', type=str, default="/srv/scratch1/fnoora/gqa/vg_gqa_imgfeat/vg_gqa_obj36-36.h5")
    parser.add_argument('--lmdb', type=str, default="/srv/scratch1/fnoora/gqa/vg_gqa_imgfeat/volta/gqa_boxes36.lmdb")
